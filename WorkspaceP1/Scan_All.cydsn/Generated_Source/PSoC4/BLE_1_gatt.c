    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'P', (uint8)'r', (uint8)'u', (uint8)'e', (uint8)'b', (uint8)'a', (uint8)'B', (uint8)'l', (uint8)'e',
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0001u, (void *)&cyBle_attValues[12] }, /* Resolvable Private Address Only */
    { 0x0004u, (void *)&cyBle_attValues[13] }, /* Service Changed */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[0] }, /* Client Characteristic Configuration */
    { 0x0002u, (void *)&cyBle_attValues[17] }, /* Supported New Alert Category */
    { 0x0002u, (void *)&cyBle_attValues[19] }, /* New Alert */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0002u, (void *)&cyBle_attValues[21] }, /* Supported Unread Alert Category */
    { 0x0002u, (void *)&cyBle_attValues[23] }, /* Unread Alert Status */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[4] }, /* Client Characteristic Configuration */
    { 0x0002u, (void *)&cyBle_attValues[25] }, /* Alert Notification Control Point */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x1Au] = {
    ...
    { 0x0009u, 0x2AC9u /* Resolvable Private Address Only     */, 0x01020001u /* rd    */, 0x0009u, {{0x0001u, (void *)&cyBle_attValuesLen[3]}} },
    ...
    { 0x000Fu, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0010u, {{0x2A47u, NULL}}                           },
    { 0x0010u, 0x2A47u /* Supported New Alert Category        */, 0x01020001u /* rd    */, 0x0010u, {{0x0002u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00100001u /* ntf   */, 0x0013u, {{0x2A46u, NULL}}                           },
    { 0x0012u, 0x2A46u /* New Alert                           */, 0x01100000u /* ntf   */, 0x0013u, {{0x0002u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0013u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr */, 0x0013u, {{0x0002u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0014u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0015u, {{0x2A48u, NULL}}                           },
    { 0x0015u, 0x2A48u /* Supported Unread Alert Category     */, 0x01020001u /* rd    */, 0x0015u, {{0x0002u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0016u, 0x2803u /* Characteristic                      */, 0x00100001u /* ntf   */, 0x0018u, {{0x2A45u, NULL}}                           },
    { 0x0017u, 0x2A45u /* Unread Alert Status                 */, 0x01100000u /* ntf   */, 0x0018u, {{0x0002u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0018u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr */, 0x0018u, {{0x0002u, (void *)&cyBle_attValuesLen[11]}} },
    { 0x0019u, 0x2803u /* Characteristic                      */, 0x00080001u /* wr    */, 0x001Au, {{0x2A44u, NULL}}                           },
    { 0x001Au, 0x2A44u /* Alert Notification Control Point    */, 0x01080100u /* wr    */, 0x001Au, {{0x0002u, (void *)&cyBle_attValuesLen[12]}} },
};
