...
#define CYBLE_GAP_ROLE_BROADCASTER                  (0u != (CYBLE_GAP_ROLE & CYBLE_GAP_BROADCASTER))
    ...
    #define CYBLE_FAST_SCAN_INTERVAL                (0x0320u)
    #define CYBLE_FAST_SCAN_WINDOW                  (0x0320u)
...
#define CYBLE_ADV_PKT_INDEX_MANUFACTURER_DATA   (0x03u)
...
#if(CYBLE_MODE_PROFILE)
    #if(CYBLE_M0S8BLESS_VERSION_2)
        #define CYBLE_LL_MAX_TX_PAYLOAD_SIZE            (0x1Du)
        #define CYBLE_LL_MAX_RX_PAYLOAD_SIZE            (0x1Du)
